 ...
 *
 * To compile:
 *   cc -o ip_coursework_023 ip_coursework_023.c -lm
 *
 * To run:
 *   ./ip_coursework_023
 *
...
void detect_edges(unsigned char *in, unsigned char *out,Shu_thread *args) {
  int i;
